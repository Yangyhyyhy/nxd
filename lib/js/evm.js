/* evm.js -v 0.1.0 -build on 2014-12-29. 
...
var ajax = function() {
  var xhrId = 0,
    ...
    Ajax = function(url, data, callback, abort, timeout, context) {
      ...
      if(argsLen === 1) {
        ...
        if(typeof args == 'object') {
          if(!args.url)
            throw new Error('*url* attribute is undefined');
          url = args.url;
          if(!args.callback)
            throw new Error('*callback* attribute is undefined');
      ...
      xhr.onabort = function() {
        xhr.onreadystatechange = null;
        (abort ? abort: callback).call(context || xhr, 'ABORT');
      };
      xhr.ontimeout = function() {
        xhr.onreadystatechange = null;
        (timeout ? timeout : callback).call(context || xhr, 'TIMEOUT');
      };
    ...
    function checkContent(r) {
      ...
      if(contentType.indexOf("application/x-png") !== -1) {}
      //.jpg .jpeg .jpe
      if(contentType.indexOf("image/jpeg") !== -1) {}
      if(contentType.indexOf("application/x-jpg") !== -1) {}
